...
function wh_menu() {
    return '    <div class="row g-3 m-3 mt-5">
        <div class="col-md-6">
            <a href="wh.php" class="btn btn-primary btn-lg rounded-pill w-100 py-3">Depo Ana Sayfa</a>
        </div>
        <div class="col-md-6">
            <a href="./" class="btn btn-primary btn-lg rounded-pill w-100 py-3">Ana Sayfa</a>
        </div>
    </div>
