...
<div class="container mt-5">
    <div class="mt-5">
        ...
        <h4 class="btn-outline-primary" data-bs-toggle="collapse" data-bs-target="#productAccordion" aria-expanded="true" aria-controls="productAccordion">Çıkış İçin Bekleyen Ürünler <small>(<?= count($products) ?> adet) <i>Görmek için basınız</i></small></h4>
