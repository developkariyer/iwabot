...
<div class="container mt-5">
    ...
    <form action = "controller.php" method = "post">
        ...
        <?= productSelect() ?>
        <textarea name="description" class="form-control btn-outline-success rounded-pill w-100 py-3 mt-2" placeholder="İsim - Adres - Açıklama - Ürün Kodları" required></textarea>
